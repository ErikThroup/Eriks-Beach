...
export default class World {
  ...
  loadBlenderModel() {
    ...
    this.waitForPhysicsThenAddTrimesh(this.blenderModel)
  }
  ...
  loadFlyingMachine() {
    ...
    this.waitForPhysicsThenAddTrimesh(this.flyingMachine)
  }
  ...
  loadJapaneseHouse() {
    ...
    this.waitForPhysicsThenAddTrimesh(this.japaneseHouse)
    ...
    // Line of lights from x-38 to x-60 at y2 z22
    const numLights2 = 8
